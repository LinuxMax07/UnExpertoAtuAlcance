...
$db = conectarDB();
$id = $_GET['id'];
$productos = mysqli_query($db, "SELECT * FROM productos WHERE id='$id'");
?>
        ...
        <?php while ($producto = mysqli_fetch_assoc($productos)) : ?>
            <div class="card-detalle">
                <div class="card-datalle_imagen">
                    <?php
                    if ($producto['imagen'] == '') {
                        echo '<img  src="portal/uploads/productos/default_poduct.png" alt="" />';
                    } else {
                        echo '<img  src="portal/uploads/productos/' . $producto['imagen'] . '" alt="" />';
                    }
                    ?>
