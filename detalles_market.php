...
$db = conectarDB();
$id = $_GET['id'];
$marketplaces = mysqli_query($db, "SELECT * FROM marketplace WHERE id='$id'");
?>

<main>
    <div class="fondo-pag-detalles">
        <?php while ($producto = mysqli_fetch_assoc($marketplaces)) : ?>
            <div class="card-detalle">
                <div class="card-datalle_imagen">

                    <?php
                    if ($producto['imagen'] == '') {
                        echo '<img src="portal/uploads/marketplace/default_poduct.png" alt="" />';
                    } else {
                        echo '<img src="portal/uploads/marketplace/' . $producto['imagen'] . '" alt="" />';
                    }
                    ?>
                </div>
