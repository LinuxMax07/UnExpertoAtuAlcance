        ...
        <ul>
            <li title="Features"><label for="tab1" role="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                        <path fill="currentColor" d="m5.8 21l1.6-7L2 9.2l7.2-.6L12 2l2.8 6.6l7.2.6l-3.2 2.8H18c-.7 0-1.4.1-2.1.4l2.2-1.9l-4.4-.4l-1.7-4l-1.7 4l-4.4.4l3.3 2.9l-1 4.3l3.8-2.3l.5.3c-.2.5-.4 1.1-.4 1.6L5.8 21M17 14v3h-3v2h3v3h2v-3h3v-2h-3v-3h-2Z" />
                    </svg>
                    <br><span>Mis Servicios</span></label>
            </li>

            <button type="button" id="btn-registrar-producto" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticModal-servicio">+ Agregar Servicio</button>
...
<div class="modal fade" id="staticModal-servicio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title titulo-modal-servicio" id="staticBackdropLabel">Registro de Servicio </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">

                <form id="form-crear-servicio" action="#" enctype="multipart/form-data">

                    <div class="seccion-info-General">
                        <div>
                            <h2 class="text-center">Foto del servicio</h2>
                            ...
                            <div class="file-drop-area">
                                ...
                                <input accept=".jpg, .jpeg, .png" name="imagenServicio" id="imagen_servicio" class="file-input" type="file" multiple>
                        ...
                        <div>
                            ...
                            <div class="d-flex gap-5">
                                <div class="form-group mt-3 w-100">
                                    ...
                                    <input type="text" id="input-nombre" name="nombre" class="form-control" required placeholder="Nombre del servicio">
                                </div>
                                <div class="form-group mt-3 w-100">
                            ...
                            <div class="d-flex gap-5">
                                <div class="form-group mt-3 w-100">
                                    ...
                                    <input type="number" id="input-precio" name="precio" class="form-control" required placeholder="Precio del servicio">
                                </div>
                                <div class="form-group mt-3 w-100">
                    ...
                    <div class="w-100 mt-5">
                        ...
                        <input type="text" hidden class="form-control" id="token-servicio" name="tokenServicio" value="">
...
<script src="js/servicios.js?v=<?php echo (rand()); ?>"></script>